...
export const TRANSPORT_MODE_META = {
  bike: { label: 'Vélo', color: '#52B788' },
  scooter: { label: 'Trottinette', color: '#D9A441' },
  public_transport: { label: 'Métro', color: '#1A3A2A' },
  car: { label: 'Voiture', color: '#7FA98C' },
  walk: { label: 'À pied', color: '#6B8F87' },
}
